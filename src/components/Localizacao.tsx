...
type Clinica = {
  slug: "canoas" | "balneario-camboriu";
  nome: string;
  endereco: string;
  bairro: string;
  cep: string;
  whatsapp: string;      // formato exibido (ex.: "+55 51 99630-5040")
  embedSrc: string;      // URL do iframe do Google Maps
};
...
export function Localizacao() {
  const clinicas: Clinica[] = [
    ...
    },
    {
      ...
      embedSrc:
        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3523.1431870139054!2d-48.63406342386361!3d-27.00074597763507!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94d8b71056bc7e61%3A0x5e0e7e60cfc94245!2sR.%20Miguel%20Matte%2C%20687%20-%20Pioneiros%2C%20Balne%C3%A1rio%20Cambori%C3%BA%20-%20SC%2C%2088393-234!5e0!3m2!1spt-BR!2sbr!4v1691180223456!5m2!1spt-BR!2sbr",
    },
  ];

  // Detecta a cidade pelo pathname. Default: /canoas
  const pathname = typeof window !== "undefined" ? window.location.pathname : "/canoas";
  const isBC = pathname.includes("balneario-camboriu");
  const selecionadas = isBC
    ? clinicas.filter((c) => c.slug === "balneario-camboriu")
    : clinicas.filter((c) => c.slug === "canoas");
    ...
    <section id="contato" className="py-16 md:py-20 px-4 md:px-6 bg-[#F5F5F3]">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-8 md:gap-12 place-items-center">
          {selecionadas.map((clinica, index) => (
            <motion.div
              key={clinica.slug}
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: index * 0.2 }}
              className="bg-white rounded-lg shadow-lg overflow-hidden w-full max-w-3xl mx-auto"
            >
              ...
              <div className="p-6">
                <h3
                  className="text-lg text-[#1E1E1E] mb-4"
                  style={{ fontFamily: "DM Sans, sans-serif", fontWeight: 600, letterSpacing: "0.05em" }}
                >
                  📍 {clinica.nome}
                </h3>
